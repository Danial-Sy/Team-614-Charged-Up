...
// output -> {
// // if statement to ensure motors do not output too much or too little power
// to
// // reach setpoint
...
// public void execute() {
// super.execute();
// SmartDashboard.putNumber("Rotate Gyro setpoint value",
// getController().getSetpoint());
// SmartDashboard.putNumber("Rotate Gyro current value",
// DriveTrainSubsystem.navX.getAngle());
// }
